      ...
      <DottedSurface className="min-h-[60vh] w-full">
        <div className="relative z-10 flex min-h-[60vh] items-center justify-center px-4 py-24 sm:px-6">
          <motion.div
            ...
            className="w-full max-w-2xl overflow-hidden rounded-2xl bg-gradient-to-b from-white/25 via-white/10 to-white/5 p-[1px] shadow-[0_16px_50px_-16px_rgba(0,0,0,0.85)]"
          >
