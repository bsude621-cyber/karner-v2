    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-20 flex flex-col items-center px-6 text-center">
        ...
        <motion.p
          ...
          className="mb-6 text-sm uppercase tracking-[0.4em] text-accent-light"
        >
Yazılım ve Medya Şirketi
        ...
        <motion.h1
          ...
          className="max-w-4xl text-5xl font-semibold leading-[1.05] sm:text-7xl"
        >
          Geleceği{" "}
      ...
      <motion.div
        ...
        className="absolute bottom-8 z-20 flex flex-col items-center gap-2 text-white/60"
      >
