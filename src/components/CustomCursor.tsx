...
/**
 * İmleç efekti (yalnızca hassas işaretçi / mouse): imlecin peşinde giden mor
 * parıltı + ince halka. İki temada da AYNI efekt; tek fark karışım modu —
 * karanlıkta "screen" (parıltı aydınlatır), aydınlıkta "multiply" (parıltı
 * koyulaştırır). Aynı ışık, zemine göre ters yön.
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          // screen koyu zeminde aydınlatır ama açık zeminde görünmez kalır;
          // aydınlıkta multiply aynı morun koyulaştıran karşılığı.
      ...
      <div
        ...
        style={{
          ...
          boxShadow: light
            ? "0 0 10px rgba(123,63,228,0.45)"
            : "0 0 12px rgba(123,63,228,0.8)",
        }}
      />
    </>
  );
