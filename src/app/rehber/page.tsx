...
const DESCRIPTION =
  "KARNER teknik rehberleri: 3D web sitesi, yapay zekâ aramasında görünmek, llms.txt, schema.org, Core Web Vitals, n8n otomasyon, AI reklam videosu ve mobil uygulama. Satış metni değil, nasıl çalıştığının açıklaması.";
...
const clusterOrder: GuideCluster[] = ["geo", "web", "otomasyon", "video", "mobil"];
